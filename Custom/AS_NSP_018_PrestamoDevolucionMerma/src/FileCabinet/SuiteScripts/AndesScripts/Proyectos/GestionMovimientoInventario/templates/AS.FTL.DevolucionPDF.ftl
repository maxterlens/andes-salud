...
<#-- AS_NSP_018 - Prestamo, Devolucion y Merma
     Comprobante de devolucion: lo que vuelve de la bodega de prestamos.
...
<head>
    ...
    <macrolist>
        <macro id="nlheader">
            ...
            <div class="doc-title"><span style="font-size: 14pt;">COMPROBANTE DE DEVOLUCION </span><span style="font-size: 14pt;">${doc.cabecera.numero}</span></div>
            </td>
...
<table class="block">
<tr>
<td class="block-title">Datos de la devolucion</td>
<td class="block-title text-right"><strong>Fecha de devolucion:</strong> ${doc.cabecera.fecha}</td>
</tr>
<tr>
<td class="label">Prestamo relacionado</td>
<td class="value">${doc.cabecera.prestamo}</td>
</tr>
<tr>
...
<tr>
<td class="label">Responsable de la devolucion</td>
