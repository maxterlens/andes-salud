...
<head>
    ...
    <macrolist>
        <macro id="nlheader">
            ...
            <div class="doc-title"><span style="font-size: 14pt;">COMPROBANTE DE MERMA </span><span style="font-size: 14pt;">${doc.cabecera.numero}</span></div>
            </td>
...
<table class="block">
<tr>
<td class="block-title">Datos de la merma</td>
<td class="block-title text-right"><strong>Fecha de la merma:</strong> ${doc.cabecera.fecha}</td>
</tr>
<tr>
...
<tr>
<td class="label">Ubicacion de la merma</td>
<td class="value">${doc.cabecera.origen}</td>
</tr>
<tr>
<td class="label">Motivo de baja</td>
<td class="value">${doc.cabecera.motivo}</td>
</tr>
<tr>
<td class="label">Cuenta de ajuste</td>
<td class="value">${doc.cabecera.cuenta}</td>
</tr>
<tr>
<td class="label">Responsable de la merma</td>
...
<tr>
<td class="label">Ajuste generado</td>
...
<table class="block">
<tr>
<td class="block-title" colspan="2">Autorizacion de la baja</td>
</tr>
<tr>
