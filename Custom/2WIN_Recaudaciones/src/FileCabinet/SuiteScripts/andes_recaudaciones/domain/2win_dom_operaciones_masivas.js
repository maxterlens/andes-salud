define([
    ...
    function obtenerUuid(idCarpeta) {
        try {
            ...
            // Generar uuid
            let uuid = libAuditoria.obtenerToken(); // Generar token para auditoria
            nLog.audit("obtenerUuid - uuid", { 
                uuid: uuid
            });
    ...
    class OperacionMasiva {
        ...
        procesar(parametro) {
            try {
                ...
                // Ajustar datos para registro de auditoria
                proceso.nombreProceso = this.nombre
                proceso.etapa = "procesar";
                proceso.scriptId = runtime.getCurrentScript().id;
                
                // Generar token unico para auditoria
                proceso.tokenProceso = obtenerUuid(this.folderId);
                ...
                const uuid = proceso.tokenProceso;
                ...
                proceso.descripcionResultado = tieneMapReduceActivo 
