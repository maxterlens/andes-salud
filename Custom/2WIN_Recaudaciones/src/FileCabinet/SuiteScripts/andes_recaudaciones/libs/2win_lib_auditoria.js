...
define(["N/search", "N/record", "N/log"], function (search, record, nLog) {
    ...
    /**
     * @function actualizarCamposRegistro - Función para actualizar campos de un registro en netsuite.
     * @param {object} parametro - Parametros a usar en la actualizacion.
     * @returns {string} - internalid de registro actualizado.
     */
    function actualizarCamposRegistro(parametro) {
        try {
            nLog.audit("actualizarCamposRegistro - parametro", {
                parametro: parametro,
            });

            // Actualizar registro con nuevos valores
            const internalidRegistroActualizado = record.submitFields({
                // type: "transaction",
                type: parametro.recordtype,
                id: parametro.internalid,
                values: parametro.campos,
                options: {
                    enableSourcing: false,
                    ignoreMandatoryFields : true
                }
            });
            nLog.debug("actualizarCamposRegistro - internalidRegistroActualizado", {
                internalidRegistroActualizado: internalidRegistroActualizado
            });
    ...
    return {
        ...
        actualizarCamposRegistro: actualizarCamposRegistro
    };
});
