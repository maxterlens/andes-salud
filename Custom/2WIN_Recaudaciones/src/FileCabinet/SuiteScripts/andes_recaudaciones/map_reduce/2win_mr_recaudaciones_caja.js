...
define([
                    ...
                    errores: [
                        {
                            ...
                            encabezado: datos ? datos.encabezado : null,
                            folio: movimiento ? movimiento.folio : null,
    ...
    function summarize(summary) {
        ...
        // Recuperar id de archivo con JSON de datos de entrada
        const archivo = daoFile.cargarArchivo(datosEntrada);
        ...
        const identificadorUnicoProceso = name.replace(/\.json$/i, "");

        // Buscar registro de auditoria por identificador unico de proceso
        let internalidRegistroAuditoria = libAuditoria.busquedaDatosAuditoria(identificadorUnicoProceso)[0].internalid;
        ...
        let parametroActualizacionRegistroAuditoria = {
            ...
            campos: {
                ...
                "custrecord_2win_auditoria_etapa": summarize.name
            }
        };
        ...
        try {
            ...
            if (movimientosConErrores.length > 0) {
                // Actualizar campos auditoria
                parametroActualizacionRegistroAuditoria.campos.custrecord_2win_auditoria_estado = "001";
                parametroActualizacionRegistroAuditoria.campos.custrecord_2win_auditoria_descripcion = movimientosConErrores[0].errores[0].error;
            } else {
                // Actualizar campos auditoria
                parametroActualizacionRegistroAuditoria.campos.custrecord_2win_auditoria_descripcion = "Procesamiento completado exitosamente";
            }

            // Actualizar registro auditoria
