...
define(["N/log"], function(nLog) {
     ...
     * @param {string} data.boletaNula - "S" si la boleta está anulada, "N" si está vigente.
     */
    class BoletaEmitidaDTO {
        constructor(data) {
            ...
            // this.boletaNula = data.boletaNula || "N";
            this.boletaNula = data.boletaNula;
            ...
            this.isValid = function () {
                ...
                if (!this.boletaNula) {
                    nLog.error({ title: "Validación Fallida", details: "boletaNula es requerida" });
                    return false;
                } else if (!["S", "N"].includes(this.boletaNula)) {
                    nLog.error({ title: "Validación Fallida", details: "boletaNula es tiene un valor invalido" });
                    return false;
                };
