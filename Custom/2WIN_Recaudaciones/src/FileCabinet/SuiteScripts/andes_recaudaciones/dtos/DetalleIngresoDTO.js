/**
 * @module DetalleIngresoDTO
 * @description Data Transfer Object para un detalle de ingreso.
 */
define(["N/log"], function(nLog) {

    /**
     * @alias DetalleIngresoDTO
     * @class
     * @param {Object} data - Objeto con los datos para inicializar el DTO.
     * @param {string} data.codigoIngreso - Código del ingreso.
