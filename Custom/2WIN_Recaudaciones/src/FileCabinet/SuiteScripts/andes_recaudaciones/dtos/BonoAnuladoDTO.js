/**
 * @module BonoAnuladoDTO
 * @description Data Transfer Object para un bono anulado.
 */
define(["N/log"], function(nLog) {

    /**
     * @alias BonoAnuladoDTO
     * @class
     * @param {Object} data - Objeto con los datos para inicializar el DTO.
     * @param {string} data.folioBono - Folio del bono anulado.
