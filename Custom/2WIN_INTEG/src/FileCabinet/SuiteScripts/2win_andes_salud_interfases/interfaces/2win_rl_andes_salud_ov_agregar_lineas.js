 ...
 * @NApiVersion 2.1
 * @NScriptType Restlet
 * @description Script para recepcion de datos Andes Salud."Ingresos amabulatorios SEND^IN"
 * @swagger
 * components:
 *   securitySchemes:
 *     OAuth2:
 ...
 *
 * /restlet.nl?script=2148&deploy=1:
 *   put:
 *     security:
 *       - OAuth2: []
 *     tags:
 *       - Ingresos Ambulatorios + Ingresos Hospitalizados
 *     summary: Agregar lineas a orden de venta SEND^IN.
 *     description: Recibe objeto con datos desde Andes Salud y edita la orden de venta existente en NetSuite agregando lineas, correspondientes al mensaje SEND^IN.
 *     parameters:
 *       - name: script
 *         in: query
 ...
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/RespuestaSendIn'
 *       '400':
