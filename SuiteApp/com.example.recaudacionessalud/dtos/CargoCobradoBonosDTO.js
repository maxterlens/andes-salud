/**
 * @module CargoCobradoBonosDTO
 * @description Data Transfer Object para un cargo cobrado en bonos.
 */
define(["N/log"], function(nLog) {

    /**
     * @alias CargoCobradoBonosDTO
     * @class
