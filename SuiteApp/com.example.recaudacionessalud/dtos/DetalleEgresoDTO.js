/**
 * @module DetalleEgresoDTO
 * @description Data Transfer Object para un detalle de egreso.
 */
define(["N/log"], function(nLog) {

    /**
     * @alias DetalleEgresoDTO
     * @class
     * @param {Object} data - Objeto con los datos para inicializar el DTO.
     * @param {string} data.codigoEgreso - Código del egreso.
