/**
 * @module DetalleEgresoAnuladoDTO
 * @description Data Transfer Object para un detalle de egreso anulado.
 */
define(["N/log"], function(nLog) {

    /**
     * @alias DetalleEgresoAnuladoDTO
     * @class
     * @param {Object} data - Objeto con los datos para inicializar el DTO.
     * @param {string} data.codigoEgreso - Código del egreso anulado.
     ...
     */
    class DetalleEgresoAnuladoDTO {
        constructor(data) {
            this.codigoEgreso = data.codigoEgreso;
            ...
            this.isValid = function () {
                if (!this.codigoEgreso) {
                    nLog.error({ title: "Validación Fallida", details: "codigoEgreso es requerido." });
                    return false;
                }
                if (!this.montoTotal) {
            ...
            this.toObject = function () {
                return {
                    codigoEgreso: this.codigoEgreso,
    ...
    return DetalleEgresoAnuladoDTO;
});
